"""
weight_optimizer_v8.py

Optimizes feature weights for the H-Score using scipy SLSQP.
Identical to v7 in every way EXCEPT the objective function.

v7 objective: maximize Spearman rho across full distribution
v8 objective: maximize mean Precision@25 across snapshot dates
...
Save to: optimal_weights_v8.json

Usage:
    python weight_optimizer_v8.py
    python weight_optimizer_v8.py --features features_multiwindow.parquet
    python weight_optimizer_v8.py --n-init 100 --k 25
"""
...
def main():
    ...
    parser.add_argument("--out",      default="optimal_weights_v8.json")
